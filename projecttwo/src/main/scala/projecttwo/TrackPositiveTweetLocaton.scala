...
object TrackPositiveTweetLocaton {
    ...
    val staticDf3 = spark.read.option("inferSchema", "true").json("twitterstream1")

    staticDf1.printSchema()
    ...
    val df1=staticDf1
      ...
      .groupBy("Time_In_EST")
      .count().withColumnRenamed("count","positive_tweet_having_address")
      .toDF()
      ...
      .groupBy("Time_In_EST")
      .count().withColumnRenamed("count","positive_tweet_not_having_address")
      .toDF()
    ...
    .toDF()
      ...
      df3.join(df1,"Time_In_EST").join(df2,"Time_In_EST").sort(functions.desc("positive_tweet_having_address")).show()
  }
